 ...
 * a half of 8. Write a function function solution($A);
 ...
 * The function should return −1 if array A does not have a dominator. For example, given array A such that
 * A[0] = 3    A[1] = 4    A[2] =  3    A[3] = 2    A[4] = 3    A[5] = -1    A[6] = 3    A[7] = 3
 * the function may return 0, 2, 4, 6 or 7, as explained above. Write an efficient algorithm for the following assumptions:
...
function solution($A) {
    ...
    if ($candidat) {
        return array_search($candidat, $A);
    } else {
        return -1;
    }
}
