 ...
 * Triplet (0, 2, 4) is triangular. Write a function: function solution($A);
 ...
 * the function should return 0. Write an efficient algorithm for the following assumptions:
