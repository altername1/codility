 ...
 * east and Q is traveling to the west. For example, consider array A such that: A[0] = 0, A[1] = 1, A[2] = 0, A[3] = 1, A[4] = 1
 * We have five pairs of passing cars: (0, 1), (0, 3), (0, 4), (2, 3), (2, 4). Write a function: function solution($A);
 * that, given a non-empty array A of N integers, returns the number of pairs of passing cars.
 * The function should return −1 if the number of pairs of passing cars exceeds 1,000,000,000. For example, given:
