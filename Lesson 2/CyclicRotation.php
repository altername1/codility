 ...
 * (elements are shifted right by one index and 6 is moved to the first place). The goal is to rotate array A K times; that is,
 * each element of A will be shifted to the right K times. Write a function: function solution($A, $K);
